...
inline half4 SurfaceCore(half3 worldNormal, half3 worldPos, half3 lightDir, half3 viewDir, half2 uv) {
    fixed4 c = UNITY_ACCESS_INSTANCED_PROP(Props, _Color);
        ...
        c = lerp(c, UNITY_ACCESS_INSTANCED_PROP(Props, _FlatSpecularColor), specularTransition * tex2D(_SpecularMap, uv));
    #endif  // DR_SPECULAR_ON
...
void surfObject(InputObject IN, inout SurfaceOutputDustyroom o) {
    ...
    half4 c = SurfaceCore(blendedNormal, IN.worldPos, IN.lightDir, IN.viewDir, IN.uv_MainTex);
